...
module.exports = async (req, res) => {
    ...
    var author;
    try {
        author = (await axios.get(`${config.apiUrl}/user?username=${encodeURIComponent(req.params.username)}`, {
            auth: {
    ...
    res.json({
        ...
        updatedAt: post.updatedAt.getTime() !== post.createdAt.getTime() ? post.updatedAt : null
    });
};